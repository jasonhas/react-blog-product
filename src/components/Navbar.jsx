        ...
        <div className='max-w-7xl mx-auto pt-8'>
            <nav className='border-gray-200 px-2 mb-10'>
                <div className='container mx-auto flex flex-wrap items-center justify-between'>
                    <Link to="/" className='flex'><FaGlobe className='text-4xl text-blue-800'/><span className='my-auto px-3'>Innovate</span></Link>
                    ...
                    <div class="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
                        <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                            ...
                            <li>
                                <Link to="/products" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Products</Link>
                            </li>
                            <li>
                                <Link to="/contact" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Contact Us</Link>
                            </li>
                        </ul>
                    </div>
                </div>
